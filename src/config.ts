//export var url: string = 'http://localhost/iccServer';
//export var url: string = 'http://192.168.1.7/iccServer';
...
//export var url: string = 'http://www.controldata.co.th/mpsicc/iccServer';
